...
namespace Twitter.MVC.Controllers
{
    ...
    public class ManageController : BaseController
    {
        ...
        public async Task<ActionResult> RemoveLogin(string loginProvider, string providerKey)
        {
            ...
            var result =
                await this.UserManager.RemoveLoginAsync(this.User.Identity.GetUserId(),
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            var result =
                await
                    this.UserManager.ChangePhoneNumberAsync(this.User.Identity.GetUserId(), model.PhoneNumber,
                        model.Code);
            if (result.Succeeded)
            {
                var user = await this.UserManager.FindByIdAsync(this.User.Identity.GetUserId());
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            var result =
                await
                    this.UserManager.ChangePasswordAsync(this.User.Identity.GetUserId(), model.OldPassword,
                        model.NewPassword);
            if (result.Succeeded)
            {
                var user = await this.UserManager.FindByIdAsync(this.User.Identity.GetUserId());
